...
export const ClientPortal = ({ navigateTo, userRole, requests }) => {
    ...
    const translations = {
        es: {
            ...
            friendlyWarning: 'Estimado cliente, para visualizar el detalle y descargar el reporte oficial de este análisis, es necesario estar al día con los pagos correspondientes. Si ya realizó la transferencia, puede reportarla a fe@microlabscr.com para habilitar su descarga de forma inmediata. ¡Agradecemos su comprensión!',

            ...
            <body>
                ...
                <script>
                    ...
                    img.onload = function() {
                        ...
                        // Since the photo is centered, let's find a good square crop.
                        const size = 512;
                        canvas.width = size;
                        canvas.height = size;
                        ...
                        // The logo in the photo might have some borders. Let's center crop.
                        const minDim = Math.min(img.width, img.height);
                        
                        // If it's a centered photo, crop a square from the center of the original image
